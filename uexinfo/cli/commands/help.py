...
_DETAILS = {
    ...
    "trade": (
        ...
        "Alias : /t\n"
        "/help trade buy   → détail de la recherche d'achat\n"
        "/help trade sell  → détail de la recherche de vente"
    ),
    "trade buy": (
        "/trade buy <commodité>\n\n"
        "  Affiche les terminaux qui achètent (acceptent en vente) la commodité,\n"
        "  triés par prix décroissant (meilleur vendeur en tête).\n\n"
        "  Pour chaque terminal :\n"
        "    A: <prix>/□   Prix d'achat au terminal (ce que le terminal paie)\n"
        "    V: <prix>/□   Prix de vente au terminal (ce que vous payez)\n"
        "    Stock/Demande, distance depuis la position courante\n\n"
        "  Filtre actif : seuls les terminaux accessibles selon /select sont inclus.\n\n"
        "  Exemples :\n"
        "    /trade buy Copper\n"
        "    /trade buy laranite\n"
        "    /t buy gold\n\n"
        "  Les prix en orange = cache local (UEX hors-ligne).\n"
        "  Les prix en vert ★ = données joueur (scan confirmé)."
    ),
    "trade sell": (
        "/trade sell <commodité>\n\n"
        "  Affiche les terminaux qui vendent la commodité,\n"
        "  triés par prix croissant (meilleur acheteur en tête).\n\n"
        "  Pour chaque terminal :\n"
        "    V: <prix>/□   Prix de vente (ce que vous payez pour acheter)\n"
        "    Stock disponible, distance depuis la position courante\n\n"
        "  Exemples :\n"
        "    /trade sell Copper\n"
        "    /trade sell Medical Supplies\n"
        "    /t sell gold\n\n"
        "  Combine avec /trade buy pour calculer la marge :\n"
