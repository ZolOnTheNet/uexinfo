...
_SUBS_WITH_HELP: dict[str, list[tuple[str, str]]] = {
    ...
    "scan":                 [
        ...
        ("debug list", "Liste les images disponibles"),
        ("debug selected", "Sélecteur multi-images pour debug"),
        ("debug batch", "Debug OCR sur tous les fichiers d'un dossier"),
    ],
    "scan log":             [
    ...
    "dev scan":             [
        ...
        ("clear",  "Vider la screenshot_db"),
    ],
    "dev db":               [
        ("list", "Lister les n dernières entrées (défaut 20)"),
    ],
    "auto":                 [
    ...
    "nav":                  [
        ...
        ("route",             "Calcule une route (alias: itinéraire, chemin)"),
...
_COMMAND_HELP: dict[str, str] = {
    ...
    "debug": "Contrôle du niveau de trace (0-5)",
    "dev": "Mode développeur — import batch, stats DB, bypass production",
    "v": "Alias de 'voyage'",
