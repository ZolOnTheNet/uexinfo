...
SUBS: dict[str, list[tuple[str, str]]] = {
    ...
    "config": [
        ...
        ("clock",                  "Horloge de fond dans l'overlay (on|off)"),
        ("cmdhistory",             "Nb commandes+résultats conservés (1-50)"),
        ("magasins",               "Afficher les magasins dans la vue terminal (on|off)"),
        ("restaurants",            "Afficher les restaurants dans la vue terminal (on|off)"),
        ("services",               "Afficher les services dans la vue terminal (on|off)"),
    ...
    "config sctrade":     [("on", "Activer"), ("off", "Désactiver")],
    "config close":       [("normal", "✕ ferme immédiatement"), ("dblclick", "✕ masque, double-clic ferme")],
    "config clock":       [("on", "Activer"), ("off", "Désactiver")],
    "config magasins":    [("on", "Activer"), ("off", "Désactiver")],
    "config restaurants": [("on", "Activer"), ("off", "Désactiver")],
    "config services":    [("on", "Activer"), ("off", "Désactiver")],
    ...
    "config scan": [
        ...
        ("logpath",      "Chemin vers app.log de SC-Datarunner (PAS Game.log du jeu)"),
        ("screenshots",  "Dossier screenshots de Star Citizen"),
    ],
    "config scan mode": [
